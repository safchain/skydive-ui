...
export class SKOvsPort extends SKInterface {}

export class SKOvsBridge extends SKBridge {
  ...
  private ports: SKFlowLayout = new SKFlowLayout(
    "ports", "sk-ovs-ports", SKFlowLayoutOrientation.Horizontal, this.layerMargin, this.layerPadding);
